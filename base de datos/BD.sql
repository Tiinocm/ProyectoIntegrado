...
insert into  noticias(id_noticia ,id_comunidad,usuario,fecha,votos,imagen_portada,publicidad,titulo,posiciones)
	value(1,1,'zarzu','2022-05-09',2,'imagen/portada',1,'hola',1),
		(2,2,'tino','2022-05-10',4,'imagen/noticia',1,'quetal',10),
        (3,3,'alejandro','2022-05-11',5,'imagen/informacion',0,'futbol',11),
        (4,5,'candela','2022-05-13',3,'imagen/informacion',1,'tennis',20),
        (6,7,'paula','2022-05-14',7,'imagen/contrapotada',0,'basquet',30);
...
insert into parrafos(id_noticia ,posicion,texto)
 ...
 insert into Usuario(usuario,moderador,fecha_creacion,email,contraseña )
	value('zarzu1',1,'2022-05-10','czc@gmail.com','12345zcg'),
		('tino2',0,'2022-03-24','tino@gmail.com','124fffsfdf'),
		('alejendro3',1,'2022-02-24','alejandro@gmail.com','1234dfg'),
		('candela4',1,'2022-05-10','zarzu@gmail.com','1233fg4w'),
		('paula5',0,'2022-05-10','candela@gmail','132dsadasf');
