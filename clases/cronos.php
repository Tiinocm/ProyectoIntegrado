...
/* hecho por tino */
    public function drawNoticias($lugar)
    {
        ...
        for ($i; $i < $countFor; $i++) { 
            ...
            $str .= "<a href='noticiaIndividual.php?id=". $this->publicadas[$i]->getId() . "'><div class='titulo'>" . $this->publicadas[$i]->getTitulo() . "</div>" . '<div class="votos"><i class="fa-regular fa-heart"></i> <span id="countvotos">123</span</div>' . "</a>";
