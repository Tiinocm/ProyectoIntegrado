...
/* hecho por tino */
    public function drawNoticias($lugar)
    {
        ...
        for ($i; $i < $countFor; $i++) { 
            ...
            if ($lugar != "destacadas") {
                $str .= '<li class="textNoticia"><a href="noticiaIndividual.php?id=' . $this->publicadas[$i]->getId() . '"><div class="tituloT">' . $this->publicadas[$i]->getTitulo() . '</div></a><div class="votos"><i class="fa-regular fa-heart"></i> <span id="countvotos">123</span</div></li>';
            }
        }
        echo $str;  
    }
