    ...
    public function drawNoticias($lugar)
    {
        ...
        */
        ...
        for ($i; $i < $countFor; $i++) { 
            ...
            $str .= "<div class='titulo'><a href='noticiaIndividual.php?id=". $this->publicadas[$i]->getId() . "'>" . $this->publicadas[$i]->getTitulo() . '<div class="votos"><i class="icon fa-regular fa-heart id=' . $this->publicadas[$i]->getId() . '"></i></a></div> <span id="countvotos">123</span></div>';
